	...
	*/
	...
	var _user = {
	    ...
	    getQuestion : function(username, resolve, reject){
	        _pg.request({
	            url     : _pg.getServerUrl('/user/forget_get_question.do'),
	            data    : {
	                username : username
	            },
	            method  : 'POST',
	    ...
	    checkAnswer : function(userInfo, resolve, reject){
	        _pg.request({
	            url     : _pg.getServerUrl('/user/forget_check_answer.do'),
	            data    : userInfo,
	            method  : 'POST',
	            success : resolve,
	            error   : reject
	    ...
	    resetPassword : function(userInfo, resolve, reject){
	        _pg.request({
	            url     : _pg.getServerUrl('/user/forget_reset_password.do'),
	            data    : userInfo,
	            method  : 'POST',
	            success : resolve,
	            error   : reject
	    ...
	    getUserInfo : function(resolve, reject){
	        _pg.request({
	            url     : _pg.getServerUrl('/user/get_information.do'),
	            method  : 'POST',
	            success : resolve,
	            error   : reject
	        });
	    ...
	    updateUserInfo : function(userInfo, resolve, reject){
	        _pg.request({
	            url     : _pg.getServerUrl('/user/update_information.do'),
	            data    : userInfo,
	            method  : 'POST',
	            success : resolve,
	            error   : reject
	    ...
	    updatePassword : function(userInfo, resolve, reject){
	        _pg.request({
	            url     : _pg.getServerUrl('/user/reset_password.do'),
	            data    : userInfo,
	            method  : 'POST',
	            success : resolve,
	            error   : reject
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _pg = __webpack_require__(98);
	var _product        = __webpack_require__(126);
	var Pagination      = __webpack_require__(127);
	var templateIndex   = __webpack_require__(131);

	var page = {
	    data : {
	        listParam : {
	            keyword         : _pg.getUrlParam('keyword')    || '',
	            categoryId      : _pg.getUrlParam('categoryId') || '',
	            orderBy         : _pg.getUrlParam('orderBy')    || 'default',
	            pageNum         : _pg.getUrlParam('pageNum')    || 1,
	            pageSize        : _pg.getUrlParam('pageSize')   || 20
	        }
	    },
	    init : function(){
	        this.onLoad();
	    ...
	    loadList : function(){
	        ...
	        _product.getProductList(listParam, function(res){
	            listHtml = _pg.renderHtml(templateIndex, {
	                list :  res.list
	            });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _pg                 = __webpack_require__(98);
	var templatePagination  = __webpack_require__(130);
	...
	Pagination.prototype.getPaginationHtml = function(){
	    ...
	    html = _pg.renderHtml(templatePagination, {
	        pageArray   : pageArray,
